...
const NSSS_SOLUTION_ERROR = 9.420570723895535e-16
const NSSS_RESIDUAL_NORM = 1.683941263006812e-15
...
const BLOCKS = [
    (
        ...
        solution_names = ["α", "➕₁₀"],
        previous_solution_values = [0.8111657946199845, 0.3, 2.182509516501624],
        external_solution_values = Float64[],
        solution_values = [1.8834086344418175, 0.8111657946199845],
        previous_solution_initial_values = [0.8111657946199845, 0.3, 2.182509516501624],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.8834086344418175, 0.8111657946199845],
    ...
    (
        ...
        previous_solution_initial_values = [0.11480054308526577],
        external_solution_initial_values = Float64[],
        solution_initial_values = [6.5600310334437735],
    ...
    (
        ...
        solution_names = ["i"],
        previous_solution_values = [10.079547224816302],
        external_solution_values = Float64[],
        solution_values = [0.2519886806204076],
        previous_solution_initial_values = [10.079547224816302],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.2519886806204076],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
        ...
        external_solution_values = Float64[],
        solution_values = [1.0115776081424936, 3.6358259916618003, 0.8111657946199845, 0.11480054308526577, 10.079547224816302, 0.017811704834605608, 2.182509516501624, 1.0631544752403927, 1.0, 0.03772089598850476, 0.1633775302203009, 0.16337753022030094, 1.0, 1.0, 0.9999999999999998, 0.9999999999999998, 0.3],
        previous_solution_initial_values = [0.3],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.0115776081424936, 3.6358259916618003, 0.8111657946199845, 0.11480054308526577, 10.079547224816302, 0.017811704834605608, 2.182509516501624, 1.0631544752403927, 1.0, 0.03772089598850476, 0.1633775302203009, 0.16337753022030094, 1.0, 1.0, 1.0, 1.0, 0.3],
...
const BLOCK_PREVIOUS_SOLUTION_VALUES = [
    [0.8111657946199845, 0.3, 2.182509516501624],
    [0.11480054308526577],
    [10.079547224816302],
    [0.3],
    Float64[],
...
const BLOCK_SOLUTION_VALUES = [
    [1.8834086344418175, 0.8111657946199845],
    [6.5600310334437735],
    [0.2519886806204076],
    [1.0115776081424936, 3.6358259916618003, 0.8111657946199845, 0.11480054308526577, 10.079547224816302, 0.017811704834605608, 2.182509516501624, 1.0631544752403927, 1.0, 0.03772089598850476, 0.1633775302203009, 0.16337753022030094, 1.0, 1.0, 0.9999999999999998, 0.9999999999999998, 0.3],
    [0.3],
]
...
const BLOCK_SOLUTION_INITIAL_VALUES = [
    ...
    [6.5600310334437735],
    [0.2519886806204076],
    [1.0115776081424936, 3.6358259916618003, 0.8111657946199845, 0.11480054308526577, 10.079547224816302, 0.017811704834605608, 2.182509516501624, 1.0631544752403927, 1.0, 0.03772089598850476, 0.1633775302203009, 0.16337753022030094, 1.0, 1.0, 1.0, 1.0, 0.3],
    [0.3],
]
