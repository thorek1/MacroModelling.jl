...
const NSSS_SOLUTION_ERROR = 4.611102534756203e-16
const NSSS_RESIDUAL_NORM = 4.2741862426241777e-16
...
const BLOCKS = [
    (
        ...
        solution_names = ["nx", "➕₁₅"],
        previous_solution_values = [0.06451768392335211, 0.006578315360122507, 0.9716601882753793, 0.6451768392329371],
        external_solution_values = Float64[],
        solution_values = [0.002192685448202311, 0.006578315360122507],
        previous_solution_initial_values = [0.06451768392335211, 0.006578315360122507, 0.9716601882753793, 0.6451768392329371],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.0021926854482023114, 0.006578315360122507],
    ...
    (
        ...
        solution_names = ["i_y"],
        previous_solution_values = [0.1476061264018076, 0.6451768392329371],
        external_solution_values = Float64[],
        solution_values = [0.22878398204327868],
        previous_solution_initial_values = [0.1476061264018076, 0.6451768392329371],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.22878398204327868],
    ...
    (
        ...
        previous_solution_values = [0.006578315360122507, 2.6078820919047287],
        external_solution_values = Float64[],
        solution_values = [0.1476061264018076, 0.006578315360122507, 0.006578315360122507],
        previous_solution_initial_values = [0.006578315360122507, 2.6078820919047287],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.1476061264018076, 0.006578315360122507, 0.006578315360122507],
    ...
    (
        ...
        solution_names = ["c_y"],
        previous_solution_values = [0.49615604296422655, 0.6451768392329371],
        external_solution_values = Float64[],
        solution_values = [0.7690233325085194],
        previous_solution_initial_values = [0.49615604296422655, 0.6451768392329371],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.7690233325085194],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
        ...
        external_solution_values = Float64[],
        solution_values = [0.06451768392335211, 0.06451768392329371, 0.49615604296422655, 2.6078820919047287, 0.3321686927235321, 0.9716601882753793, 0.029166381484582272, -1.6664438374559885, 1.2091352911878386, -1.596996194025858, 0.6451768392329371, 0.3343610060955074, 0.6678313072764679, 0.6000802292422954, 5.839773109528323e-14, 0.006578315360122507, 0.006578315360122507, 0.0],
        previous_solution_initial_values = [0.006578315360122507, 0.0, -0.0023681935296441022],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.06451768392335211, 0.06451768392329371, 0.49615604296422655, 2.6078820919047287, 0.3321686927235321, 0.9716601882753793, 0.029166381484582272, -1.6664438374559885, 1.2091352911878388, -1.596996194025858, 0.6451768392329371, 0.33436100609550734, 0.6678313072764678, 0.6000802292422953, 5.839773109528153e-14, 0.006578315360122507, 0.006578315360122507, 0.0],
...
const BLOCK_PREVIOUS_SOLUTION_VALUES = [
    [0.06451768392335211, 0.006578315360122507, 0.9716601882753793, 0.6451768392329371],
    [0.1476061264018076, 0.6451768392329371],
    [0.006578315360122507, 2.6078820919047287],
    [0.006578315360122507],
    [0.49615604296422655, 0.6451768392329371],
...
const BLOCK_SOLUTION_VALUES = [
    [0.002192685448202311, 0.006578315360122507],
    [0.22878398204327868],
    [0.1476061264018076, 0.006578315360122507, 0.006578315360122507],
    [0.006578315360122507],
    [0.7690233325085194],
    [0.06451768392335211, 0.06451768392329371, 0.49615604296422655, 2.6078820919047287, 0.3321686927235321, 0.9716601882753793, 0.029166381484582272, -1.6664438374559885, 1.2091352911878386, -1.596996194025858, 0.6451768392329371, 0.3343610060955074, 0.6678313072764679, 0.6000802292422954, 5.839773109528323e-14, 0.006578315360122507, 0.006578315360122507, 0.0],
    [-0.0023681935296441022],
    [0.0],
    [0.006578315360122507],
]
...
const BLOCK_SOLUTION_INITIAL_VALUES = [
    [0.0021926854482023114, 0.006578315360122507],
    [0.22878398204327868],
    [0.1476061264018076, 0.006578315360122507, 0.006578315360122507],
    [0.006578315360122507],
    [0.7690233325085194],
