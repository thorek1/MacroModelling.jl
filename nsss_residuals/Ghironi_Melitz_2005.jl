...
const NSSS_SOLUTION_ERROR = 1.311189919289057e-14
const NSSS_RESIDUAL_NORM = 1.5615440764156097e-15
...
const BLOCKS = [
    (
        ...
        solution_names = ["zx̄"],
        previous_solution_values = [2.938435014025517, 5.666666666666666],
        external_solution_values = Float64[],
        solution_values = [1.5815047299285394],
        previous_solution_initial_values = [2.938435014025517, 5.666666666666666],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.5815047299285394],
    ...
    (
        ...
        solution_names = ["zx"],
        previous_solution_values = [2.938435014025515, 5.666666666666666],
        external_solution_values = Float64[],
        solution_values = [1.5815047299285383],
        previous_solution_initial_values = [2.9384350140255147, 5.666666666666666],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.581504729928538],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
        ...
        previous_solution_initial_values = [3.38688240773139],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.01010101010101011, 3.38688240773139],
    ...
    (
        ...
        solution_names = ["r", "➕₁₅"],
        previous_solution_values = [3.386882407731391],
        external_solution_values = Float64[],
        solution_values = [0.01010101010101011, 3.386882407731391],
        previous_solution_initial_values = [3.386882407731391],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.01010101010101011, 3.386882407731391],
        box_lower_bounds = [-Inf, 2.220446049250313e-16],
        box_upper_bounds = [Inf, 1.0e12],
    ),
    (
        ...
        solution_names = ["TOL", "➕₅"],
        previous_solution_values = [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554, 2.938435014025517, 0.8220019677454531, 0.9999999999999992],
        external_solution_values = Float64[],
        solution_values = [1.0000000000000002, 0.8220019677454526],
        previous_solution_initial_values = [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554, 2.938435014025517, 0.8220019677454532, 0.9999999999999988],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.0000000000000002, 0.8220019677454526],
    ...
    (
        ...
        external_solution_values = Float64[],
        solution_values = [0.9999999999999992],
        previous_solution_initial_values = [1.0000000000000004],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.9999999999999988],
    ...
    (
        ...
        solution_names = ["➕₄"],
        previous_solution_values = [2.938435014025515],
        external_solution_values = Float64[],
        solution_values = [0.8220019677454531],
        previous_solution_initial_values = [2.9384350140255147],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.8220019677454532],
        box_lower_bounds = [2.220446049250313e-16],
        box_upper_bounds = [1.0e12],
    ),
    (
        ...
        solution_names = ["Q̃"],
        previous_solution_values = [1.0, 0.9999999999999987],
        external_solution_values = Float64[],
        solution_values = [1.0000000000000002],
        previous_solution_initial_values = [1.0, 0.9999999999999987],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.0000000000000004],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
        ...
        solution_names = ["➕₇"],
        previous_solution_values = [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554],
        external_solution_values = Float64[],
        solution_values = [0.9999999999999987],
        previous_solution_initial_values = [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.9999999999999987],
        box_lower_bounds = [2.220446049250313e-16],
        box_upper_bounds = [1.0e12],
    ),
    (
        ...
        external_solution_values = Float64[],
        solution_values = [3.386882407731391, 3.38688240773139, 7.506952650706397, 7.506952650706407, 0.19248596540272828, 1.5798796065733571, 1.5798796065733554, 0.19248596540272886, 1.0, 0.11313270650973102, 0.0870217286331078, 0.08702172863310763, 0.12406886813900495, 0.124068868139005, 0.11313270650973081, 3.142484747007702, 3.1424847470077033, 2.938435014025515, 2.938435014025517, 2.2953723636801193, 2.2953723636801207, 1.8868005996535895, 1.8868005996535893, 3.142484747007702, 3.1424847470077033, 0.3403172080467582, 20.451494655678296, 3.1424847470077033, 20.451494655678328, 0.34031720804675797, 3.142484747007702, 1.3],
        previous_solution_initial_values = [1.0, 1.0, 5.666666666666666, 1.3571428571428572],
        external_solution_initial_values = Float64[],
        solution_initial_values = [3.386882407731391, 3.38688240773139, 7.506952650706397, 7.506952650706407, 0.19248596540272828, 1.5798796065733571, 1.5798796065733554, 0.19248596540272886, 1.0, 0.11313270650973102, 0.0870217286331078, 0.08702172863310763, 0.12406886813900488, 0.12406886813900493, 0.11313270650973081, 3.142484747007702, 3.1424847470077033, 2.9384350140255147, 2.938435014025517, 2.2953723636801198, 2.2953723636801207, 1.8868005996535897, 1.8868005996535893, 3.142484747007702, 3.1424847470077033, 0.3403172080467582, 20.4514946556783, 3.1424847470077033, 20.451494655678324, 0.34031720804675797, 3.142484747007702, 1.3],
    ...
    (
        ...
        external_solution_initial_values = Float64[],
        solution_initial_values = [5.666666666666666],
        box_lower_bounds = [2.220446049250313e-16],
        box_upper_bounds = [1.0e12],
    ),
    (
        ...
        previous_solution_initial_values = Float64[],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.3571428571428572],
        box_lower_bounds = [2.220446049250313e-16],
        box_upper_bounds = [1.0e12],
    ),
    (
...
const BLOCK_PREVIOUS_SOLUTION_VALUES = [
    [2.938435014025517, 5.666666666666666],
    [2.938435014025515, 5.666666666666666],
    [3.38688240773139],
    [3.386882407731391],
    [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554, 2.938435014025517, 0.8220019677454531, 0.9999999999999992],
    [1.0000000000000002],
    [2.938435014025515],
    [1.0, 0.9999999999999987],
    [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554],
...
const BLOCK_SOLUTION_VALUES = [
    ...
    [0.01010101010101011, 3.386882407731391],
    [1.0000000000000002, 0.8220019677454526],
    [0.9999999999999992],
    [0.8220019677454531],
    [1.0000000000000002],
    [0.9999999999999987],
    [3.386882407731391, 3.38688240773139, 7.506952650706397, 7.506952650706407, 0.19248596540272828, 1.5798796065733571, 1.5798796065733554, 0.19248596540272886, 1.0, 0.11313270650973102, 0.0870217286331078, 0.08702172863310763, 0.12406886813900495, 0.124068868139005, 0.11313270650973081, 3.142484747007702, 3.1424847470077033, 2.938435014025515, 2.938435014025517, 2.2953723636801193, 2.2953723636801207, 1.8868005996535895, 1.8868005996535893, 3.142484747007702, 3.1424847470077033, 0.3403172080467582, 20.451494655678296, 3.1424847470077033, 20.451494655678328, 0.34031720804675797, 3.142484747007702, 1.3],
    [5.666666666666666],
    [1.3571428571428572],
    [1.0],
    [1.0],
...
const BLOCK_PREVIOUS_SOLUTION_INITIAL_VALUES = [
    [2.938435014025517, 5.666666666666666],
    [2.9384350140255147, 5.666666666666666],
    [3.38688240773139],
    [3.386882407731391],
    [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554, 2.938435014025517, 0.8220019677454532, 0.9999999999999988],
    [1.0000000000000004],
    [2.9384350140255147],
    [1.0, 0.9999999999999987],
    [7.506952650706397, 7.506952650706407, 1.5798796065733571, 1.5798796065733554],
