...
const NSSS_SOLUTION_ERROR = 1.5467975853072253e-15
const NSSS_RESIDUAL_NORM = 1.5467975853072253e-15
...
const BLOCKS = [
    (
        ...
        previous_solution_initial_values = [0.9706929055197505],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.9706929055197505],
    ...
    (
        ...
        previous_solution_values = [0.18871000385176437, 0.07906734939506334, 0.0, 0.33472169155853454],
        external_solution_values = Float64[],
        solution_values = [9.71445146547012e-17],
        previous_solution_initial_values = [0.18871000385176437, 0.07906734939506334, 0.0, 0.33472169155853454],
        external_solution_initial_values = Float64[],
        solution_initial_values = [9.71445146547012e-17],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
        ...
        external_solution_values = Float64[],
        solution_values = [0.0],
        previous_solution_initial_values = [0.06694433831170692, 0.33472169155853454],
        external_solution_initial_values = Float64[],
    ...
    (
        ...
        external_solution_values = Float64[],
        solution_values = [0.18871000385176437, 0.2062499999999999, 0.9706929055197505, 0.07906734939506334, 0.6816150809919252, 0.8, 0.19999999999999996, 0.16499999999999992, 5.299136132631956, 4.1150670794633655, 0.33472169155853454, 5.299136132631956],
        previous_solution_initial_values = [0.06694433831170692],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.18871000385176437, 0.2062499999999999, 0.9706929055197505, 0.07906734939506334, 0.6816150809919252, 0.8, 0.19999999999999996, 0.16499999999999992, 5.299136132631956, 4.1150670794633655, 0.33472169155853454, 5.299136132631956],
...
const BLOCK_PREVIOUS_SOLUTION_VALUES = [
    [0.9706929055197505],
    Float64[],
    [0.18871000385176437, 0.07906734939506334, 0.0, 0.33472169155853454],
...
const BLOCK_SOLUTION_VALUES = [
    ...
    [9.71445146547012e-17],
    [0.0],
    [0.18871000385176437, 0.2062499999999999, 0.9706929055197505, 0.07906734939506334, 0.6816150809919252, 0.8, 0.19999999999999996, 0.16499999999999992, 5.299136132631956, 4.1150670794633655, 0.33472169155853454, 5.299136132631956],
    [0.06694433831170692],
]
