...
const NSSS_SOLUTION_ERROR = 6.304854800243424e-16
const NSSS_RESIDUAL_NORM = 3.35284488644461e-15
...
const BLOCKS = [
    (
        ...
        solution_names = ["util"],
        previous_solution_values = [0.42223506320231197],
        external_solution_values = Float64[],
        solution_values = [-1.3683490243936816],
        previous_solution_initial_values = [0.42223506320231197],
        external_solution_initial_values = Float64[],
        solution_initial_values = [-1.3683490243936816],
    ...
    (
        ...
        solution_names = ["➕₃", "➕₅"],
        previous_solution_values = [1.116950781911715, 1.0074179936054601],
        external_solution_values = Float64[],
        solution_values = [0.42223506320231197, 1.0074179936054601],
        previous_solution_initial_values = [1.116950781911715, 1.0074179936054601],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.42223506320231197, 1.0074179936054601],
    ...
    (
        ...
        solution_names = ["tbʸ"],
        previous_solution_values = [1.116950781911715, 0.33976852797384144, 1.4864873098855613],
        external_solution_values = Float64[],
        solution_values = [0.02002573436183362],
        previous_solution_initial_values = [1.116950781911715, 0.33976852797384144, 1.4864873098855613],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.02002573436183362],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
    ...
    (
        ...
        external_solution_values = Float64[],
        solution_values = [1.116950781911715, 0.7442000000001217, 1.0074179936054601, 0.33976852797384144, 3.397685279738414, 0.04000000000000009, 9.028688907619654e-17, 1.4864873098855613, 5.609077101346501, 0.42223506320231197, 1.2168044349891716e-13, 0.0],
        previous_solution_initial_values = [0.0],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.116950781911715, 0.7442000000001217, 1.0074179936054601, 0.33976852797384144, 3.397685279738414, 0.04000000000000009, 9.020562075079397e-17, 1.4864873098855613, 5.609077101346501, 0.422235063202312, 1.2168044349890976e-13, 0.0],
...
const BLOCK_PREVIOUS_SOLUTION_VALUES = [
    [0.42223506320231197],
    [1.116950781911715, 1.0074179936054601],
    [1.116950781911715, 0.33976852797384144, 1.4864873098855613],
    Float64[],
    [0.0],
    Float64[],
]
...
const BLOCK_SOLUTION_VALUES = [
    [-1.3683490243936816],
    [0.42223506320231197, 1.0074179936054601],
    [0.02002573436183362],
    [0.0],
    [1.116950781911715, 0.7442000000001217, 1.0074179936054601, 0.33976852797384144, 3.397685279738414, 0.04000000000000009, 9.028688907619654e-17, 1.4864873098855613, 5.609077101346501, 0.42223506320231197, 1.2168044349891716e-13, 0.0],
    [0.0],
]
...
const BLOCK_SOLUTION_INITIAL_VALUES = [
    ...
    [0.02002573436183362],
    [0.0],
    [1.116950781911715, 0.7442000000001217, 1.0074179936054601, 0.33976852797384144, 3.397685279738414, 0.04000000000000009, 9.020562075079397e-17, 1.4864873098855613, 5.609077101346501, 0.422235063202312, 1.2168044349890976e-13, 0.0],
    [0.0],
]
