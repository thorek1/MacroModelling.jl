...
const NSSS_SOLUTION_ERROR = 1.0795608094705824e-15
const NSSS_RESIDUAL_NORM = 8.353494156553357e-16
...
const ORIGINAL_SOLUTION_VALUES = Float64[
    ...
    0.6968376126282672,
    0.6968376126282675,
    5.042841357491782e-16,
    -4.034273085993429e-16,
    0.3031623873717329,
    0.30316238737173257,
    0.275,
    0.275,
...
const BLOCKS = [
    (
        ...
        solution_values = [0.0],
        previous_solution_initial_values = [0.825791147212849, 0.275, 1.1007911472128487],
        external_solution_initial_values = Float64[],
        solution_initial_values = [-4.034273085993429e-16],
    ...
    (
        ...
        solution_names = ["NX{F}"],
        previous_solution_values = [0.8257911472128492, 0.275, 1.10079114721285],
        external_solution_values = Float64[],
        solution_values = [8.068546171986849e-16],
        previous_solution_initial_values = [0.8257911472128492, 0.275, 1.1007911472128498],
        external_solution_initial_values = Float64[],
        solution_initial_values = [5.042841357491782e-16],
        box_lower_bounds = [-Inf],
        box_upper_bounds = [Inf],
    ),
    (
        ...
        external_solution_values = Float64[],
        solution_values = [0.6063247747434658, 0.6063247747434651, 0.8257911472128492, 0.825791147212849, 0.2788534213100842, 0.6968376126282672, 0.6968376126282675, 0.3031623873717329, 0.30316238737173257, 1.3545569805169557, 1.3545569805169553, 1.10079114721285, 1.100791147212849, 1.0973730994934203, 1.0973730994934132, 0.9899763180304794, 0.9899763180304794, 1.1045199649645072, 0.7496960373944879, 0.7382487517198121, 1.1045199649645072, 1.104519964964508, 0.749696037394486, 0.7382487517198119, 1.104519964964508, 11.0, 11.0],
        previous_solution_initial_values = [11.0, 11.0, 1.0000000000000009, 1.0000000000000009, 0.275, 0.275],
        external_solution_initial_values = Float64[],
        solution_initial_values = [0.6063247747434658, 0.6063247747434651, 0.8257911472128492, 0.825791147212849, 0.2788534213100842, 0.6968376126282672, 0.6968376126282675, 0.3031623873717329, 0.30316238737173257, 1.3545569805169555, 1.354556980516955, 1.1007911472128498, 1.1007911472128487, 1.0973730994934203, 1.0973730994934132, 0.9899763180304794, 0.9899763180304794, 1.1045199649645072, 0.7496960373944883, 0.7382487517198121, 1.104519964964507, 1.1045199649645079, 0.7496960373944866, 0.7382487517198121, 1.1045199649645079, 11.0, 11.0],
    ...
    (
        ...
        previous_solution_initial_values = Float64[],
        external_solution_initial_values = Float64[],
        solution_initial_values = [1.0000000000000009, 1.0000000000000009],
...
const BLOCK_PREVIOUS_SOLUTION_VALUES = [
    ...
    [0.8257911472128492, 0.275, 1.10079114721285],
...
const BLOCK_SOLUTION_VALUES = [
    [0.0],
    [8.068546171986849e-16],
    [0.6063247747434658, 0.6063247747434651, 0.8257911472128492, 0.825791147212849, 0.2788534213100842, 0.6968376126282672, 0.6968376126282675, 0.3031623873717329, 0.30316238737173257, 1.3545569805169557, 1.3545569805169553, 1.10079114721285, 1.100791147212849, 1.0973730994934203, 1.0973730994934132, 0.9899763180304794, 0.9899763180304794, 1.1045199649645072, 0.7496960373944879, 0.7382487517198121, 1.1045199649645072, 1.104519964964508, 0.749696037394486, 0.7382487517198119, 1.104519964964508, 11.0, 11.0],
    [0.275],
    [0.275],
    [0.275],
    [0.275],
...
const BLOCK_PREVIOUS_SOLUTION_INITIAL_VALUES = [
    [0.825791147212849, 0.275, 1.1007911472128487],
    [0.8257911472128492, 0.275, 1.1007911472128498],
    [11.0, 11.0, 1.0000000000000009, 1.0000000000000009, 0.275, 0.275],
    [0.275],
    [11.0],
    [0.275],
