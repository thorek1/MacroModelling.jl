...
∇₂ = calculate_hessian(RBC_CME.parameter_values,SS_and_pars,RBC_CME)# * RBC_CME.cache.second_order_auxiliary_matrices.𝐔∇₂
∇₃ = calculate_third_order_derivatives(RBC_CME.parameter_values,SS_and_pars,RBC_CME)# * RBC_CME.cache.third_order_auxiliary_matrices.𝐔∇₃
...
# second_order_solution *= RBC_CME.cache.second_order_auxiliary_matrices.𝐔₂

second_order_solution = sparse(second_order_solution * RBC_CME.cache.second_order_auxiliary_matrices.𝐔₂)
...
third_order_solution, solved3 = calculate_third_order_solution(∇₁, 
                                                            ...
                                                            RBC_CME.cache.second_order_auxiliary_matrices, 
                                                            RBC_CME.cache.third_order_auxiliary_matrices, 
                                                            RBC_CME.caches; 
                                                            T = T)

# third_order_solution *= RBC_CME.cache.third_order_auxiliary_matrices.𝐔₃

third_order_solution = sparse(third_order_solution * RBC_CME.cache.third_order_auxiliary_matrices.𝐔₃)
...
@testset verbose = true "SS, derivatives of model at SS and solutions" begin
    ...
    @test isapprox(∇₃ * RBC_CME.cache.third_order_auxiliary_matrices.𝐔∇₃
