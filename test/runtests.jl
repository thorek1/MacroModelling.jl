...
if test_set == "plots_5"
    ...
    @testset verbose = true "SW07 estim" begin
        ...
        shock_mat = randn(Smets_Wouters_2007.constants.timings.nExo,3)
        ...
        shock_mat = sprandn(Smets_Wouters_2007.constants.timings.nExo, 10, .1)
        ...
        shock_mat = sprandn(FS2000.constants.timings.nExo, 10, .1)
...
if test_set == "basic"
    ...
    @testset verbose = true "Steady state Smets_Wouters_2003 model" begin 
        ...
        @test isapprox(get_steady_state(Smets_Wouters_2003, verbose = true)(Smets_Wouters_2003.constants.timings.var,[:Steady_state]),
                        [  1.2043777509278788
                        1.2043777484127967
                        0.362
                        0.362
    ...
    @testset verbose = true "First order perturbation" begin
        ...
        get_solution(RBC_CME)
        @test isapprox(RBC_CME.solution.perturbation.first_order.solution_matrix[:,[(end-RBC_CME.constants.timings.nExo+1):end...]], [    0.0          0.0068
