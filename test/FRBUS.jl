...
@model FRBUS begin
	...
	ebfi_l[0] = y_ebfi_l_8 * hgpbfir[-1] + y_ebfi_l_6 * xb_l[-1] + y_ebfi_l_5 * zebfi[0] + y_ebfi_l_1 * ebfi_l[-1] + ebfi_l_aerr[x] + y_ebfi_l_2 * qebfi_l[-1] + y_ebfi_l_3 * AUX_ENDO_LAG_4_1[-1] + y_ebfi_l_4 * AUX_ENDO_LAG_4_2[-1] + y_ebfi_l_7 * AUX_ENDO_LAG_205_1[-1]

	ebfin_l[0] = ebfi_l[0] + pxp_l[0] + pbfir_l[0]

	ecd_l[0] = y_ecd_l_4 * zgapc2[0] + zecd[0] + y_ecd_l_1 * ecd_l[-1] + ecd_l_aerr[x] + y_ecd_l_2 * qecd_l[-1] + y_ecd_l_3 * AUX_ENDO_LAG_6_1[-1]

	ech_l[0] = y_ech_l_3 * ech_l_aerr[x] + kh_l[-1] + ech_l[-1] * y_ech_l_1 + y_ech_l_2 * AUX_ENDO_LAG_86_1[-1] + y_ech_l_4 * AUX_ENDO_LAG_7_1[-1] + y_ech_l_5 * AUX_ENDO_LAG_86_2[-1]
	...
	eco_l[0] = y_eco_l_8 * yht_l[-1] + y_eco_l_7 * yhl_l[-1] + y_eco_l_6 * yht_l[0] + y_eco_l_5 * yhl_l[0] + y_eco_l_4 * zeco[0] + eco_l[-1] * y_eco_l_1 + eco_l_aerr[x] + y_eco_l_2 * qeco_l[-1] + y_eco_l_3 * AUX_ENDO_LAG_10_1[-1]

	egfe_l[0] = fiscal_egfe * fiscal[0] + y_egfe_l_7 * xgap2[-1] + y_egfe_l_6 * xgap2[0] + y_egfe_l_5 * egfet_l[0] + y_egfe_l_1 * egfe_l[-1] + egfe_l_aerr[x] + y_egfe_l_2 * egfet_l[-1] + y_egfe_l_3 * AUX_ENDO_LAG_11_1[-1] + y_egfe_l_4 * AUX_ENDO_LAG_11_2[-1]

	egfen_l[0] = pegfr_l[0] + pxp_l[0] + egfe_l[0]

	egfet_l[0] = egfet_l[-1] * y_egfet_l_1 + pegfr_l[-1] * y_egfet_l_2 + pxp_l[-1] * y_egfet_l_3 + y_egfet_l_4 * xgdptn_l[-1] + y_egfet_l_5 * hggdpt[0] + y_egfet_l_6 * hggdpt[-1] + y_egfet_l_7 * AUX_ENDO_LAG_68_1[-1] + y_egfet_l_8 * AUX_ENDO_LAG_68_2[-1]

	egfl_l[0] = fiscal[0] * fiscal_egfl + xgap2[-1] * y_egfl_l_7 + xgap2[0] * y_egfl_l_6 + y_egfl_l_5 * egflt_l[0] + y_egfl_l_1 * egfl_l[-1] + egfl_l_aerr[x] + y_egfl_l_2 * egflt_l[-1] + y_egfl_l_3 * AUX_ENDO_LAG_14_1[-1] + y_egfl_l_4 * AUX_ENDO_LAG_14_2[-1]

	egfln_l[0] = egfl_l[0] + pgfl_l[0]

	egflt_l[0] = egflt_l[-1] * y_egflt_l_1 + y_egflt_l_2 * pgfl_l[-1] + xgdptn_l[-1] * y_egflt_l_3 + hggdpt[0] * y_egflt_l_4 + hggdpt[-1] * y_egflt_l_5 + y_egflt_l_6 * AUX_ENDO_LAG_68_1[-1] + y_egflt_l_7 * AUX_ENDO_LAG_68_2[-1]

	egse_l[0] = xgap2[-1] * y_egse_l_7 + xgap2[0] * y_egse_l_6 + y_egse_l_5 * egset_l[0] + y_egse_l_1 * egse_l[-1] + egse_l_aerr[x] + y_egse_l_2 * egset_l[-1] + y_egse_l_3 * AUX_ENDO_LAG_17_1[-1] + y_egse_l_4 * AUX_ENDO_LAG_17_2[-1]

	egsen_l[0] = pegsr_l[0] + pxp_l[0] + egse_l[0]

	egset_l[0] = egset_l[-1] * y_egset_l_1 + pegsr_l[-1] * y_egset_l_2 + pxp_l[-1] * y_egset_l_3 + xgdptn_l[-1] * y_egset_l_4 + hggdpt[0] * y_egset_l_5 + hggdpt[-1] * y_egset_l_6 + y_egset_l_7 * AUX_ENDO_LAG_68_1[-1] + y_egset_l_8 * AUX_ENDO_LAG_68_2[-1]

	egsl_l[0] = xgap2[-1] * y_egsl_l_7 + xgap2[0] * y_egsl_l_6 + y_egsl_l_5 * egslt_l[0] + y_egsl_l_1 * egsl_l[-1] + egsl_l_aerr[x] + y_egsl_l_2 * egslt_l[-1] + y_egsl_l_3 * AUX_ENDO_LAG_20_1[-1] + y_egsl_l_4 * AUX_ENDO_LAG_20_2[-1]

	egsln_l[0] = egsl_l[0] + pgsl_l[0]

	egslt_l[0] = egslt_l[-1] * y_egslt_l_1 + y_egslt_l_2 * pgsl_l[-1] + xgdptn_l[-1] * y_egslt_l_3 + hggdpt[0] * y_egslt_l_4 + hggdpt[-1] * y_egslt_l_5 + y_egslt_l_6 * AUX_ENDO_LAG_68_1[-1] + y_egslt_l_7 * AUX_ENDO_LAG_68_2[-1]

	eh_l[0] = y_eh_l_7 * d83[x] + y_eh_l_5 * rme[-1] + zeh[0] + y_eh_l_1 * eh_l[-1] + eh_l_aerr[x] + y_eh_l_2 * qeh_l[-1] + y_eh_l_3 * AUX_ENDO_LAG_23_1[-1] + y_eh_l_4 * AUX_ENDO_LAG_23_2[-1] + y_eh_l_6 * AUX_ENDO_LAG_175_1[-1]

	ehn_l[0] = pxp_l[0] + phr_l[0] + eh_l[0]

	emn_l[0] = emon_l[0] * y_emn_l_2 + empn_l[0] * y_emn_l_3

	emo_l[0] = y_emo_l_3 * AUX_EXO_LAG_367_0[-1] + y_emo_l_2 * pmo_l[-1] + emo_ltilde[0] + emo_l[-1] * y_emo_l_1 + y_emo_l_4 * xgdpn_l[-1] + xgap2[0] * y_emo_l_5 + xgap2[-1] * y_emo_l_6 + y_emo_l_7 * AUX_ENDO_LAG_213_1[-1] + y_emo_l_8 * ddockm[x] + y_emo_l_9 * AUX_EXO_LAG_282_0[-1]

	emo_ltilde[0] = (1 - rho_emo_l) * emo_lbar + rho_emo_l * emo_ltilde[-1] + emo_l_aerr[x]
	...
	ex_l[0] = y_ex_l_10 * ddockx[x] + y_ex_l_1 * ex_l[-1] + ex_l_aerr[x] + pxr_l[-1] * y_ex_l_2 + pxp_l[-1] * y_ex_l_3 + y_ex_l_4 * fpx_l[-1] + y_ex_l_5 * fgdp_l[-1] + y_ex_l_6 * fpc_l[-1] + y_ex_l_7 * fxgap[0] + y_ex_l_8 * fxgap[-1] + y_ex_l_9 * AUX_ENDO_LAG_53_1[-1]

	exn_l[0] = pxr_l[0] + pxp_l[0] + ex_l[0]
	...
	fgdpt_l[0] = y_fgdpt_l_1 * fgdpt_l[-1] + y_fgdpt_l_2 * xgdpt_l[-1] + hggdpt[0] * y_fgdpt_l_3 + hggdpt[-1] * y_fgdpt_l_4 + y_fgdpt_l_5 * AUX_ENDO_LAG_68_1[-1] + y_fgdpt_l_6 * AUX_ENDO_LAG_68_2[-1]
	...
	fpi10[0] = fxgap[-1] * y_fpi10_6 + y_fpi10_5 * fpitrg[x] + y_fpi10_1 * fpi10[-1] + y_fpi10_2 * AUX_ENDO_LAG_42_1[-1] + y_fpi10_3 * AUX_ENDO_LAG_42_2[-1] + y_fpi10_4 * AUX_ENDO_LAG_42_3[-1]
	...
	fpxrr_l[0] = fpxrr_ltilde[0] + y_fpxrr_l_1 * fpxrr_l[-1] + y_fpxrr_l_4 * fpxrrt[x] + y_fpxrr_l_3 * AUX_ENDO_LAG_47_1[-1] + y_fpxrr_l_2 * AUX_EXO_LAG_303_0[-1]

	fpxrr_ltilde[0] = (1 - rho_fpxrr_l) * fpxrr_lbar + rho_fpxrr_l * fpxrr_ltilde[-1] + fpxrr_l_aerr[x]

	frl10[0] = fxgap[-1] * y_frl10_6 + fxgap[0] * y_frl10_5 + y_frl10_4 * frs10[0] + y_frl10_1 * frl10[-1] + y_frl10_2 * frs10[-1] + y_frl10_3 * AUX_ENDO_LAG_49_1[-1]

	frs10[0] = rfrs10[x] + fxgap[0] * y_frs10_8 + fpitrg[x] * y_frs10_7 + y_frs10_1 * dfmprr[x] + y_frs10_2 * frstar[-1] + fpi10[0] * y_frs10_3 + fpi10[-1] * y_frs10_4 + y_frs10_5 * AUX_ENDO_LAG_42_1[-1] + y_frs10_6 * AUX_ENDO_LAG_42_2[-1]

	frstar[0] = frstar[-1] * y_frstar_1 + frs10[0] * y_frstar_2 + fpi10[0] * y_frstar_3 + fpi10[-1] * y_frstar_4 + y_frstar_5 * AUX_ENDO_LAG_42_1[-1] + y_frstar_6 * AUX_ENDO_LAG_42_2[-1]

	ftcin_l[0] = y_ftcin_l_2 * uftcin[x] + ynicpn_l[0]

	fxgap[0] = xgap2[-1] * y_fxgap_13 + frstar[0] * y_fxgap_12 + fpi10[-1] * y_fxgap_4 + frs10[-1] * y_fxgap_3 + fxgap_aerr[x] + fxgap[-1] * y_fxgap_1 + y_fxgap_2 * AUX_ENDO_LAG_53_1[-1] + y_fxgap_5 * AUX_ENDO_LAG_42_1[-1] + y_fxgap_6 * AUX_ENDO_LAG_42_2[-1] + y_fxgap_7 * AUX_ENDO_LAG_42_3[-1] + y_fxgap_8 * AUX_ENDO_LAG_50_1[-1] + y_fxgap_9 * AUX_ENDO_LAG_42_4[-1] + y_fxgap_10 * AUX_ENDO_LAG_50_2[-1] + y_fxgap_11 * AUX_ENDO_LAG_42_5[-1]
	...
	ugfdbtp_l[0] = (1 - rho_ugfdbtp_l) * ugfdbtp_lbar + rho_ugfdbtp_l * ugfdbtp_l[-1] + ugfdbtp_lerr[x]
	...
	gtrd[0] = 0.0014 * (fiscalav[0] - y_gtrd_6 * fiscalav[-1]) + y_gtrd_6 * gtrd[-1] + gtrd_aerr[x] + xgap2[0] * y_gtrd_1 + xgap2[-1] * y_gtrd_2 + y_gtrd_3 * AUX_ENDO_LAG_213_1[-1] + y_gtrd_4 * AUX_ENDO_LAG_213_2[-1] + y_gtrd_5 * AUX_ENDO_LAG_213_3[-1] + y_gtrd_7 * AUX_ENDO_LAG_213_4[-1]
	...
	hgpkir[0] = y_hgpkir_1 * hgpkir[-1] + y_hgpkir_2 * pkir[x] + y_hgpkir_3 * AUX_EXO_LAG_337_0[-1]
	...
	hlept[0] = y_hlept_1 * hqlfpr[0] + y_hlept_2 * n16_l[x] + y_hlept_3 * AUX_EXO_LAG_325_0[-1]
	...
	hxbt[0] = hmfpt[0] + hks[0] * y_hxbt_5 + hlept[0] * y_hxbt_1 + hqlww[0] * y_hxbt_2 + y_hxbt_3 * lqualt_l[x] + y_hxbt_4 * AUX_EXO_LAG_321_0[-1]
	...
	ki_l[0] = ki_l[-1] * y_ki_l_1 + ki_l_aerr[x] + y_ki_l_2 * qkir_l[0] + y_ki_l_3 * xfs_l[-1] + y_ki_l_4 * AUX_ENDO_LAG_87_1[-1] + y_ki_l_5 * AUX_ENDO_LAG_210_1[-1] + y_ki_l_6 * AUX_ENDO_LAG_210_2[-1]
	...
	leo_l[0] = xgap2[-1] * y_leo_l_5 + y_leo_l_4 * qlf_l[-1] + leo_l_aerr[x] + y_leo_l_1 * qleor[x] + qlf_l[0] + y_leo_l_2 * leo_l[-1] + y_leo_l_3 * AUX_EXO_LAG_343_0[-1]
	...
	lhp_l[0] = y_lhp_l_7 * hlprdt[-1] + y_lhp_l_6 * xbo_l[-1] + y_lhp_l_5 * xbo_l[0] + y_lhp_l_4 * zlhp[0] + y_lhp_l_1 * lhp_l[-1] + lhp_l_aerr[x] + y_lhp_l_2 * qlhp_l[-1] + y_lhp_l_3 * AUX_ENDO_LAG_96_1[-1] + y_lhp_l_8 * AUX_ENDO_LAG_207_1[-1] + y_lhp_l_9 * AUX_ENDO_LAG_74_1[-1]
	...
	pbfir_l[0] = pbfir_l[-1] + dpadj[0] + pxp_l[-1] + pbfir_l_aerr[x] + pipxnc[0] * y_pbfir_l_1 - pxp_l[0]

	pcdr_l[0] = y_pcdr_l_1 * pcdr_l[-1] + y_pcdr_l_2 * AUX_ENDO_LAG_103_1[-1]

	pcer_l[0] = pcer_l[-1] + pcer_l_aerr[x] + pmp_l[0] * y_pcer_l_1 + y_pcer_l_2 * pcxfe_l[0] + pmp_l[-1] * y_pcer_l_3 + y_pcer_l_4 * pcxfe_l[-1]

	pcfr_l[0] = pcfr_l_aerr[x] + y_pcfr_l_1 * pcfr_l[-1] + y_pcfr_l_6 * pcfrt[x] + y_pcfr_l_5 * AUX_ENDO_LAG_105_3[-1] + y_pcfr_l_4 * AUX_ENDO_LAG_105_2[-1] + y_pcfr_l_3 * AUX_ENDO_LAG_105_1[-1] + y_pcfr_l_2 * AUX_EXO_LAG_329_0[-1]

	pchr_l[0] = y_pchr_l_1 * pchr_l[-1] + y_pchr_l_2 * AUX_ENDO_LAG_106_1[-1]
	...
	pegfr_l[0] = pegfr_l[-1] + dpadj[0] + pxp_l[-1] + pegfr_l_aerr[x] + pipxnc[0] * y_pegfr_l_1 - pxp_l[0]

	pegsr_l[0] = pegsr_l[-1] + dpadj[0] + pxp_l[-1] + pegsr_l_aerr[x] + pipxnc[0] * y_pegsr_l_1 - pxp_l[0]
	...
	phouse_l[0] = pcnia_l[-1] * y_phouse_l_4 + pchr_l[-1] * y_phouse_l_3 + y_phouse_l_1 * phouse_l[-1] + phouse_l_aerr[x] + y_phouse_l_2 * AUX_ENDO_LAG_117_1[-1]

	phr_l[0] = phr_l[-1] + dpadj[0] + pxp_l[-1] + phr_l_aerr[x] + pipxnc[0] * y_phr_l_1 - pxp_l[0]

	pic4[0] = pcnia_l[0] * y_pic4_1 + y_pic4_2 * AUX_ENDO_LAG_107_3[-1]

	picnia[0] = picxfe[0] + pcer_l[0] * y_picnia_1 + pcer_l[-1] * y_picnia_2 + pcfr_l[0] * y_picnia_3 + pcfr_l[-1] * y_picnia_4

	picx4[0] = pcxfe_l[0] * y_picx4_1 + y_picx4_2 * AUX_ENDO_LAG_111_3[-1]
	...
	pieci[0] = y_pieci_12 * pl_l[-1] + y_pieci_11 * qpl_l[-1] + lurnat[-1] * y_pieci_10 + lur[-1] * y_pieci_9 + huqpct[-1] * y_pieci_8 + hlprdt[-1] * y_pieci_7 + ptr[-1] * y_pieci_6 + y_pieci_5 * zpieci[0] + pieci_aerr[x] + y_pieci_1 * pieci[-1] + y_pieci_2 * AUX_ENDO_LAG_123_1[-1] + y_pieci_3 * AUX_ENDO_LAG_123_2[-1] + y_pieci_4 * AUX_ENDO_LAG_123_3[-1]

	pigdp[0] = pgdp_l[0] * y_pigdp_1 + pgdp_l[-1] * y_pigdp_2

	pipl[0] = pieci[0]

	pipxnc[0] = picnia[0] + y_pipxnc_11 * pxnc_l[-1] + y_pipxnc_10 * qpxnc_l[-1] + y_pipxnc_9 * fpxr_l[-1] + fpxr_l[0] * y_pipxnc_8 + huqpct[0] * y_pipxnc_1 + y_pipxnc_2 * pipxnc[-1] + y_pipxnc_3 * picnia[-1] + huqpct[-1] * y_pipxnc_4 + y_pipxnc_5 * AUX_ENDO_LAG_126_1[-1] + y_pipxnc_6 * AUX_ENDO_LAG_120_1[-1] + y_pipxnc_7 * AUX_ENDO_LAG_78_1[-1]

	pkbfir[0] = y_pkbfir_1 * upkbfir[x] + pbfir_l[0] * y_pkbfir_2

	pl_l[0] = pl_l[-1] + pipl[0] * y_pl_l_1

	pmo_l[0] = pmo_l[-1] * y_pmo_l_1 + pmo_ltilde[0] + y_pmo_l_2 * qpmo_l + fpc_l[-1] * y_pmo_l_3 + fpx_l[-1] * y_pmo_l_4 + pxb_l[-1] * y_pmo_l_5 + fpc_l[0] * y_pmo_l_6 + fpx_l[0] * y_pmo_l_7 + pxb_l[0] * y_pmo_l_8

	pmo_ltilde[0] = (1 - rho_pmo_l) * pmo_lbar + rho_pmo_l * pmo_ltilde[-1] + pmo_l_aerr[x]

	pmp_l[0] = y_pmp_l_2 * upmp[x] + poil_l[0]

	poil_l[0] = pxb_l[0] + poilr_l[0]

	poilr_l[0] = poilr_l_aerr[x] + y_poilr_l_1 * poilr_l[-1] + y_poilr_l_4 * poilrt[x] + y_poilr_l_3 * AUX_ENDO_LAG_133_1[-1] + y_poilr_l_2 * AUX_EXO_LAG_340_0[-1]

	ptr[0] = ptr[-1] * y_ptr_1 + picxfe[-1] * y_ptr_2 + y_ptr_3 * AUX_EXO_LAG_336_0[-1]
	...
	pxr_l[0] = pxr_l[-1] + dpadj[0] + pxp_l[-1] + pxr_l_aerr[x] + pipxnc[0] * y_pxr_l_1 - pxp_l[0]
	...
	rfynic[0] = rfynil[0] * y_rfynic_4 + y_rfynic_1 * rfynic[-1] + rfynic_aerr[x] + y_rfynic_2 * rfynil[-1] + y_rfynic_3 * AUX_ENDO_LAG_165_1[-1]

	rfynil[0] = reqp[0] * y_rfynil_8 + y_rfynil_7 * rtb[0] + rg10[0] * y_rfynil_6 + rfynil[-1] * y_rfynil_1 + rfynil_aerr[x] + y_rfynil_2 * rg10[-1] + y_rfynil_3 * rtb[-1] + reqp[-1] * y_rfynil_4 + y_rfynil_5 * AUX_ENDO_LAG_166_1[-1]

	rg10[0] = zrff10[0] + rg10p[0]

	rg10p[0] = rg10p_aerr[x] + zgap10[0] * y_rg10p_1 + y_rg10p_2 * d8095[x] + y_rg10p_3 * rg10p[-1] + zgap10[-1] * y_rg10p_4 + y_rg10p_5 * AUX_EXO_LAG_279_0[-1]

	rg30[0] = zrff30[0] + rg30p[0]

	rg30p[0] = rg30p_aerr[x] + y_rg30p_1 * zgap30[0] + d8095[x] * y_rg30p_2 + y_rg30p_3 * rg30p[-1] + y_rg30p_4 * zgap30[-1] + y_rg30p_5 * AUX_EXO_LAG_279_0[-1]

	rg5[0] = zrff5[0] + rg5p[0]

	rg5p[0] = rg5p_aerr[x] + y_rg5p_1 * zgap05[0] + y_rg5p_2 * rg5p[-1] + y_rg5p_3 * zgap05[-1]

	rgfint[0] = gfdbtn_l[-1] * y_rgfint_4 + rgfint_aerr[x] + y_rgfint_1 * rgfint[-1] + y_rgfint_2 * rgw[-1] + y_rgfint_3 * AUX_ENDO_LAG_56_1[-1]
	...
	rrff[0] = rff[0] + picxfe[0] * y_rrff_1 + picxfe[-1] * y_rrff_2 + y_rrff_3 * AUX_ENDO_LAG_122_1[-1] + y_rrff_4 * AUX_ENDO_LAG_122_2[-1]

	rrtr[0] = y_rrtr_1 * rrtr[-1] + rrff[0] * y_rrtr_2

	rspnia[0] = y_rspnia_1 * yhsn_l[0] + y_rspnia_2 * ydn_l[0]

	rtb[0] = rff[-1] * y_rtb_4 + rff[0] * y_rtb_3 + rtb[-1] * y_rtb_1 + y_rtb_2 * AUX_ENDO_LAG_179_1[-1]
	...
	rtinv[0] = pxb_l[0] * y_rtinv_7 + rbfi[0] * y_rtinv_1 + hgpkir[0] * y_rtinv_2 + pxp_l[0] * y_rtinv_3 + pkir[x] * y_rtinv_4 + pxp_l[-1] * y_rtinv_5 + y_rtinv_6 * AUX_EXO_LAG_337_0[-1]
	...
	trci[0] = xgap2[-1] * y_trci_4 + trci_aerr[x] + trcit[x] + xgap2[0] * y_trci_1 + y_trci_2 * trci[-1] + y_trci_3 * AUX_EXO_LAG_361_0[-1]

	trp[0] = xgap2[0] * y_trp_5 + trp_a[0] + trpt[0] + y_trp_1 * trp[-1] + y_trp_2 * trpt[-1] + y_trp_3 * AUX_ENDO_LAG_187_1[-1] + y_trp_4 * AUX_ENDO_LAG_189_1[-1]

	trp_a[0] = (1 - rho_trp_a) * trp_abar + rho_trp_a * trp_a[-1] + trp_aerr[x]

	trpt[0] = trpts[0]

	trptd[0] = y_trptd_3 * AUX_EXO_LAG_305_0[-1] + xgdpn_l[-1] * y_trptd_2 + gfdbtnp_l[-1] * y_trptd_1 + trpt[-1] + y_trptd_4 * AUX_ENDO_LAG_56_1[-1] + y_trptd_5 * AUX_ENDO_LAG_218_1[-1] + y_trptd_6 * AUX_EXO_LAG_305_1[-1]

	trpts[0] = trpt[-1] + xgap2[-1] * y_trpts_5 + y_trpts_1 * gfrecn_l[-1] + y_trpts_2 * gfexpn_l[-1] + xgdpn_l[-1] * y_trpts_3 + y_trpts_4 * gfsrt[-1]

	gfsrt[0] = gfsrt[-1] * rho_gfsrt + gfsrt_err[x]
	...
	xgdi_l[0] = xgdo_l[0] + mei_l

	xgdin_l[0] = pgdp_l[0] + xgdi_l[0]

	xgdo_l[0] = xgdp_l[0] - mep_l

	xgdp_l[0] = xgdp_l[-1] + xfs_l[0] * y_xgdp_l_1 + xfs_l[-1] * y_xgdp_l_2 + ki_l[0] * y_xgdp_l_3 + ki_l[-1] * y_xgdp_l_4 + y_xgdp_l_5 * AUX_ENDO_LAG_87_1[-1]
	...
	ynidn_l[0] = y_ynidn_l_3 * AUX_EXO_LAG_390_0[-1] + y_ynidn_l_2 * ynidn_l[-1] + y_ynidn_l_1 * ymsdn[x] + pxb_l[0] + pxb_l[-1] * y_ynidn_l_4 + ynidn_l_aerr[x] + y_ynidn_l_5 * qynidn_l[-1] + y_ynidn_l_6 * AUX_ENDO_LAG_244_1[-1] + zynid[0] + y_ynidn_l_8 * AUX_ENDO_LAG_135_1[-1] + y_ynidn_l_7 * AUX_EXO_LAG_390_1[-1]
	...
	zyh_l[0] = xgdpt_l[0] + zyhst_l[0] + yhgap[-1] * y_zyh_l_16 + yhgap[0] * y_zyh_l_15 + rtr[0] * y_zyh_l_14 + ptr[0] * y_zyh_l_13 + xgap2[-1] * y_zyh_l_10 + xgap2[0] * y_zyh_l_9 + rff[-1] * y_zyh_l_6 + rff[0] * y_zyh_l_5 + picnia[0] * y_zyh_l_1 + picnia[-1] * y_zyh_l_2 + y_zyh_l_3 * AUX_ENDO_LAG_120_1[-1] + y_zyh_l_4 * AUX_ENDO_LAG_120_2[-1] + y_zyh_l_7 * AUX_ENDO_LAG_164_1[-1] + y_zyh_l_8 * AUX_ENDO_LAG_164_2[-1] + y_zyh_l_11 * AUX_ENDO_LAG_213_1[-1] + y_zyh_l_12 * AUX_ENDO_LAG_213_2[-1] + y_zyh_l_17 * AUX_ENDO_LAG_225_1[-1] + y_zyh_l_18 * AUX_ENDO_LAG_225_2[-1]

	zyhp_l[0] = zyhpst_l[0] + xgdpt_l[0] + zyhst_l[0] + yhpgap[-1] * y_zyhp_l_20 + yhpgap[0] * y_zyhp_l_19 + yhgap[-1] * y_zyhp_l_16 + yhgap[0] * y_zyhp_l_15 + rtr[0] * y_zyhp_l_14 + ptr[0] * y_zyhp_l_13 + xgap2[-1] * y_zyhp_l_10 + xgap2[0] * y_zyhp_l_9 + rff[-1] * y_zyhp_l_6 + rff[0] * y_zyhp_l_5 + picnia[0] * y_zyhp_l_1 + picnia[-1] * y_zyhp_l_2 + y_zyhp_l_3 * AUX_ENDO_LAG_120_1[-1] + y_zyhp_l_4 * AUX_ENDO_LAG_120_2[-1] + y_zyhp_l_7 * AUX_ENDO_LAG_164_1[-1] + y_zyhp_l_8 * AUX_ENDO_LAG_164_2[-1] + y_zyhp_l_11 * AUX_ENDO_LAG_213_1[-1] + y_zyhp_l_12 * AUX_ENDO_LAG_213_2[-1] + y_zyhp_l_17 * AUX_ENDO_LAG_225_1[-1] + y_zyhp_l_18 * AUX_ENDO_LAG_225_2[-1] + y_zyhp_l_21 * AUX_ENDO_LAG_231_1[-1] + y_zyhp_l_22 * AUX_ENDO_LAG_231_2[-1]

	zyhpst_l[0] = zyhpst_l[-1] + yhpgap[-1] * y_zyhpst_l_1

	zyhst_l[0] = zyhst_l[-1] + yhgap[-1] * y_zyhst_l_1

	zyht_l[0] = zyhtst_l[0] + xgdpt_l[0] + zyhst_l[0] + yhtgap[-1] * y_zyht_l_20 + yhtgap[0] * y_zyht_l_19 + yhgap[-1] * y_zyht_l_16 + yhgap[0] * y_zyht_l_15 + rtr[0] * y_zyht_l_14 + ptr[0] * y_zyht_l_13 + xgap2[-1] * y_zyht_l_10 + xgap2[0] * y_zyht_l_9 + rff[-1] * y_zyht_l_6 + rff[0] * y_zyht_l_5 + picnia[0] * y_zyht_l_1 + picnia[-1] * y_zyht_l_2 + y_zyht_l_3 * AUX_ENDO_LAG_120_1[-1] + y_zyht_l_4 * AUX_ENDO_LAG_120_2[-1] + y_zyht_l_7 * AUX_ENDO_LAG_164_1[-1] + y_zyht_l_8 * AUX_ENDO_LAG_164_2[-1] + y_zyht_l_11 * AUX_ENDO_LAG_213_1[-1] + y_zyht_l_12 * AUX_ENDO_LAG_213_2[-1] + y_zyht_l_17 * AUX_ENDO_LAG_225_1[-1] + y_zyht_l_18 * AUX_ENDO_LAG_225_2[-1] + y_zyht_l_21 * AUX_ENDO_LAG_238_1[-1] + y_zyht_l_22 * AUX_ENDO_LAG_238_2[-1]

	zyhtst_l[0] = zyhtst_l[-1] + yhtgap[-1] * y_zyhtst_l_1

	zynid[0] = hggdpt[-1] * y_zynid_25 + pxb_l[-1] * y_zynid_16 + qynidn_l[-1] * y_zynid_15 + xgap[-1] * y_zynid_11 + ptr[-1] * y_zynid_10 + rtr[-1] * y_zynid_9 + rff[-1] * y_zynid_5 + picnia[-1] * y_zynid_1 + y_zynid_2 * AUX_ENDO_LAG_120_1[-1] + y_zynid_3 * AUX_ENDO_LAG_120_2[-1] + y_zynid_4 * AUX_ENDO_LAG_120_3[-1] + y_zynid_6 * AUX_ENDO_LAG_164_1[-1] + y_zynid_7 * AUX_ENDO_LAG_164_2[-1] + y_zynid_8 * AUX_ENDO_LAG_164_3[-1] + y_zynid_12 * AUX_ENDO_LAG_212_1[-1] + y_zynid_13 * AUX_ENDO_LAG_212_2[-1] + y_zynid_14 * AUX_ENDO_LAG_212_3[-1] + y_zynid_17 * AUX_ENDO_LAG_154_1[-1] + y_zynid_18 * AUX_ENDO_LAG_135_1[-1] + y_zynid_19 * AUX_ENDO_LAG_154_2[-1] + y_zynid_20 * AUX_ENDO_LAG_135_2[-1] + y_zynid_21 * AUX_ENDO_LAG_154_3[-1] + y_zynid_22 * AUX_ENDO_LAG_135_3[-1] + y_zynid_23 * AUX_ENDO_LAG_154_4[-1] + y_zynid_24 * AUX_ENDO_LAG_135_4[-1]

	ugap[0] = lur[0] - lurnat[0]

	rff[0] = rule[0] + eradd[x]

	rule[0] = rff[-1] * 0.85 + rstar * 0.15 + picx4[0] * 0.225 - 0.075 * pitarg[x] + xgap2[0] * 0.15

	fiscal[0] = (1 - rho_fiscal) * fbar_iscal + rho_fiscal * fiscal[-1] + fiscal_aerr[x]

	fiscalav[0] = fiscal[0] * av + fiscalav[-1] * rho_fiscalav

	gov_exp_share[0] = egfe_l[0] * y_xfs_l_7 * 100

	income_tax_share_of_gdp[0] = tryh[0] * 100 * (y_yh_l_2 * (( - y_yhl_l_2) - 1) + y_yh_l_4 * (( - y_yhp_l_2) - 1))

	debt_to_gdp[0] = 100 * y_gfrecn_l_5 * y_gfrecn_l_4 * y_gfdbtnp_l_4 * ( - gfdbtnp_l[0])

	AUX_ENDO_LEAD_4485[0] = pic4[1]

	AUX_ENDO_LEAD_4489[0] = AUX_ENDO_LEAD_4485[1]

	AUX_ENDO_LEAD_4493[0] = AUX_ENDO_LEAD_4489[1]

	AUX_ENDO_LEAD_4497[0] = AUX_ENDO_LEAD_4493[1]

	AUX_ENDO_LEAD_4501[0] = AUX_ENDO_LEAD_4497[1]

	AUX_ENDO_LEAD_4505[0] = AUX_ENDO_LEAD_4501[1]

	AUX_ENDO_LEAD_3940[0] = AUX_ENDO_LEAD_4505[1]

	AUX_ENDO_LAG_4_1[0] = ebfi_l[-1]

	AUX_ENDO_LAG_4_2[0] = AUX_ENDO_LAG_4_1[-1]

	AUX_ENDO_LAG_205_1[0] = xb_l[-1]

	AUX_ENDO_LAG_6_1[0] = ecd_l[-1]

	AUX_ENDO_LAG_86_1[0] = kh_l[-1]

	AUX_ENDO_LAG_7_1[0] = ech_l[-1]

	AUX_ENDO_LAG_86_2[0] = AUX_ENDO_LAG_86_1[-1]

	AUX_ENDO_LAG_10_1[0] = eco_l[-1]

	AUX_ENDO_LAG_11_1[0] = egfe_l[-1]

	AUX_ENDO_LAG_11_2[0] = AUX_ENDO_LAG_11_1[-1]

	AUX_ENDO_LAG_68_1[0] = hggdpt[-1]

	AUX_ENDO_LAG_68_2[0] = AUX_ENDO_LAG_68_1[-1]

	AUX_ENDO_LAG_14_1[0] = egfl_l[-1]

	AUX_ENDO_LAG_14_2[0] = AUX_ENDO_LAG_14_1[-1]

	AUX_ENDO_LAG_17_1[0] = egse_l[-1]

	AUX_ENDO_LAG_17_2[0] = AUX_ENDO_LAG_17_1[-1]

	AUX_ENDO_LAG_20_1[0] = egsl_l[-1]

	AUX_ENDO_LAG_20_2[0] = AUX_ENDO_LAG_20_1[-1]

	AUX_ENDO_LAG_23_1[0] = eh_l[-1]

	AUX_ENDO_LAG_23_2[0] = AUX_ENDO_LAG_23_1[-1]

	AUX_ENDO_LAG_175_1[0] = rme[-1]

	AUX_ENDO_LAG_213_1[0] = xgap2[-1]

	AUX_ENDO_LAG_53_1[0] = fxgap[-1]

	AUX_ENDO_LAG_42_1[0] = fpi10[-1]

	AUX_ENDO_LAG_42_2[0] = AUX_ENDO_LAG_42_1[-1]

	AUX_ENDO_LAG_42_3[0] = AUX_ENDO_LAG_42_2[-1]

	AUX_ENDO_LAG_47_1[0] = fpxrr_l[-1]

	AUX_ENDO_LAG_49_1[0] = frl10[-1]

	AUX_ENDO_LAG_50_1[0] = frs10[-1]

	AUX_ENDO_LAG_42_4[0] = AUX_ENDO_LAG_42_3[-1]

	AUX_ENDO_LAG_50_2[0] = AUX_ENDO_LAG_50_1[-1]

	AUX_ENDO_LAG_42_5[0] = AUX_ENDO_LAG_42_4[-1]

	AUX_ENDO_LAG_213_2[0] = AUX_ENDO_LAG_213_1[-1]

	AUX_ENDO_LAG_213_3[0] = AUX_ENDO_LAG_213_2[-1]

	AUX_ENDO_LAG_213_4[0] = AUX_ENDO_LAG_213_3[-1]

	AUX_ENDO_LAG_87_1[0] = ki_l[-1]

	AUX_ENDO_LAG_210_1[0] = xfs_l[-1]

	AUX_ENDO_LAG_210_2[0] = AUX_ENDO_LAG_210_1[-1]

	AUX_ENDO_LAG_96_1[0] = lhp_l[-1]

	AUX_ENDO_LAG_207_1[0] = xbo_l[-1]

	AUX_ENDO_LAG_74_1[0] = hlprdt[-1]

	AUX_ENDO_LAG_103_1[0] = pcdr_l[-1]

	AUX_ENDO_LAG_105_1[0] = pcfr_l[-1]

	AUX_ENDO_LAG_105_2[0] = AUX_ENDO_LAG_105_1[-1]

	AUX_ENDO_LAG_105_3[0] = AUX_ENDO_LAG_105_2[-1]

	AUX_ENDO_LAG_106_1[0] = pchr_l[-1]

	AUX_ENDO_LAG_117_1[0] = phouse_l[-1]

	AUX_ENDO_LAG_107_1[0] = pcnia_l[-1]

	AUX_ENDO_LAG_107_2[0] = AUX_ENDO_LAG_107_1[-1]

	AUX_ENDO_LAG_107_3[0] = AUX_ENDO_LAG_107_2[-1]

	AUX_ENDO_LAG_111_1[0] = pcxfe_l[-1]

	AUX_ENDO_LAG_111_2[0] = AUX_ENDO_LAG_111_1[-1]

	AUX_ENDO_LAG_111_3[0] = AUX_ENDO_LAG_111_2[-1]

	AUX_ENDO_LAG_123_1[0] = pieci[-1]

	AUX_ENDO_LAG_123_2[0] = AUX_ENDO_LAG_123_1[-1]

	AUX_ENDO_LAG_123_3[0] = AUX_ENDO_LAG_123_2[-1]

	AUX_ENDO_LAG_126_1[0] = pipxnc[-1]

	AUX_ENDO_LAG_120_1[0] = picnia[-1]

	AUX_ENDO_LAG_78_1[0] = huqpct[-1]

	AUX_ENDO_LAG_133_1[0] = poilr_l[-1]

	AUX_ENDO_LAG_68_3[0] = AUX_ENDO_LAG_68_2[-1]

	AUX_ENDO_LAG_68_4[0] = AUX_ENDO_LAG_68_3[-1]

	AUX_ENDO_LAG_68_5[0] = AUX_ENDO_LAG_68_4[-1]

	AUX_ENDO_LAG_68_6[0] = AUX_ENDO_LAG_68_5[-1]

	AUX_ENDO_LAG_68_7[0] = AUX_ENDO_LAG_68_6[-1]

	AUX_ENDO_LAG_68_8[0] = AUX_ENDO_LAG_68_7[-1]

	AUX_ENDO_LAG_68_9[0] = AUX_ENDO_LAG_68_8[-1]

	AUX_ENDO_LAG_68_10[0] = AUX_ENDO_LAG_68_9[-1]

	AUX_ENDO_LAG_68_11[0] = AUX_ENDO_LAG_68_10[-1]

	AUX_ENDO_LAG_68_12[0] = AUX_ENDO_LAG_68_11[-1]

	AUX_ENDO_LAG_68_13[0] = AUX_ENDO_LAG_68_12[-1]

	AUX_ENDO_LAG_68_14[0] = AUX_ENDO_LAG_68_13[-1]

	AUX_ENDO_LAG_165_1[0] = rfynic[-1]

	AUX_ENDO_LAG_166_1[0] = rfynil[-1]

	AUX_ENDO_LAG_56_1[0] = gfdbtn_l[-1]

	AUX_ENDO_LAG_122_1[0] = picxfe[-1]

	AUX_ENDO_LAG_122_2[0] = AUX_ENDO_LAG_122_1[-1]

	AUX_ENDO_LAG_179_1[0] = rtb[-1]

	AUX_ENDO_LAG_187_1[0] = trp[-1]

	AUX_ENDO_LAG_189_1[0] = trpt[-1]

	AUX_ENDO_LAG_218_1[0] = xgdpn_l[-1]

	AUX_ENDO_LAG_135_1[0] = pxb_l[-1]

	AUX_ENDO_LAG_244_1[0] = ynidn_l[-1]

	AUX_ENDO_LAG_120_2[0] = AUX_ENDO_LAG_120_1[-1]

	AUX_ENDO_LAG_120_3[0] = AUX_ENDO_LAG_120_2[-1]

	AUX_ENDO_LAG_164_1[0] = rff[-1]

	AUX_ENDO_LAG_164_2[0] = AUX_ENDO_LAG_164_1[-1]

	AUX_ENDO_LAG_164_3[0] = AUX_ENDO_LAG_164_2[-1]

	AUX_ENDO_LAG_212_1[0] = xgap[-1]

	AUX_ENDO_LAG_212_2[0] = AUX_ENDO_LAG_212_1[-1]

	AUX_ENDO_LAG_212_3[0] = AUX_ENDO_LAG_212_2[-1]

	AUX_ENDO_LAG_139_1[0] = qebfi_l[-1]

	AUX_ENDO_LAG_139_2[0] = AUX_ENDO_LAG_139_1[-1]

	AUX_ENDO_LAG_139_3[0] = AUX_ENDO_LAG_139_2[-1]

	AUX_ENDO_LAG_139_4[0] = AUX_ENDO_LAG_139_3[-1]

	AUX_ENDO_LAG_141_1[0] = qecd_l[-1]

	AUX_ENDO_LAG_141_2[0] = AUX_ENDO_LAG_141_1[-1]

	AUX_ENDO_LAG_141_3[0] = AUX_ENDO_LAG_141_2[-1]

	AUX_ENDO_LAG_141_4[0] = AUX_ENDO_LAG_141_3[-1]

	AUX_ENDO_LAG_225_1[0] = yhgap[-1]

	AUX_ENDO_LAG_225_2[0] = AUX_ENDO_LAG_225_1[-1]

	AUX_ENDO_LAG_225_3[0] = AUX_ENDO_LAG_225_2[-1]

	AUX_ENDO_LAG_238_1[0] = yhtgap[-1]

	AUX_ENDO_LAG_238_2[0] = AUX_ENDO_LAG_238_1[-1]

	AUX_ENDO_LAG_238_3[0] = AUX_ENDO_LAG_238_2[-1]

	AUX_ENDO_LAG_231_1[0] = yhpgap[-1]

	AUX_ENDO_LAG_231_2[0] = AUX_ENDO_LAG_231_1[-1]

	AUX_ENDO_LAG_231_3[0] = AUX_ENDO_LAG_231_2[-1]

	AUX_ENDO_LAG_142_1[0] = qeco_l[-1]

	AUX_ENDO_LAG_142_2[0] = AUX_ENDO_LAG_142_1[-1]

	AUX_ENDO_LAG_142_3[0] = AUX_ENDO_LAG_142_2[-1]

	AUX_ENDO_LAG_142_4[0] = AUX_ENDO_LAG_142_3[-1]

	AUX_ENDO_LAG_143_1[0] = qeh_l[-1]

	AUX_ENDO_LAG_143_2[0] = AUX_ENDO_LAG_143_1[-1]

	AUX_ENDO_LAG_143_3[0] = AUX_ENDO_LAG_143_2[-1]

	AUX_ENDO_LAG_143_4[0] = AUX_ENDO_LAG_143_3[-1]

	AUX_ENDO_LAG_97_1[0] = lprdt_l[-1]

	AUX_ENDO_LAG_122_3[0] = AUX_ENDO_LAG_122_2[-1]

	AUX_ENDO_LAG_98_1[0] = lur[-1]

	AUX_ENDO_LAG_99_1[0] = lurnat[-1]

	AUX_ENDO_LAG_154_1[0] = qynidn_l[-1]

	AUX_ENDO_LAG_154_2[0] = AUX_ENDO_LAG_154_1[-1]

	AUX_ENDO_LAG_135_2[0] = AUX_ENDO_LAG_135_1[-1]

	AUX_ENDO_LAG_154_3[0] = AUX_ENDO_LAG_154_2[-1]

	AUX_ENDO_LAG_135_3[0] = AUX_ENDO_LAG_135_2[-1]

	AUX_ENDO_LAG_154_4[0] = AUX_ENDO_LAG_154_3[-1]

	AUX_ENDO_LAG_135_4[0] = AUX_ENDO_LAG_135_3[-1]

	AUX_EXO_LAG_367_0[0] = uemot[x]

	AUX_EXO_LAG_282_0[0] = ddockm[x]

	AUX_EXO_LAG_303_0[0] = fpxrrt[x]

	AUX_EXO_LAG_337_0[0] = pkir[x]

	AUX_EXO_LAG_325_0[0] = n16_l[x]

	AUX_EXO_LAG_321_0[0] = lqualt_l[x]

	AUX_EXO_LAG_343_0[0] = qleor[x]

	AUX_EXO_LAG_329_0[0] = pcfrt[x]

	AUX_EXO_LAG_340_0[0] = poilrt[x]

	AUX_EXO_LAG_336_0[0] = pitarg[x]

	AUX_EXO_LAG_279_0[0] = d8095[x]

	AUX_EXO_LAG_361_0[0] = trcit[x]

	AUX_EXO_LAG_305_0[0] = gfdrt[x]

	AUX_EXO_LAG_305_1[0] = AUX_EXO_LAG_305_0[-1]

	AUX_EXO_LAG_390_0[0] = ymsdn[x]

	AUX_EXO_LAG_390_1[0] = AUX_EXO_LAG_390_0[-1]

	AUX_EXO_LAG_309_0[0] = hgpcdr[x]
...
@parameters FRBUS begin
	...
	y_gtrd_3 = (-4.93246174231e-5)

	y_gtrd_4 = (-4.93246174231e-5)

	y_gtrd_5 = (-4.93246174231e-5)
	...
	y_zecd_11 = 3.61133130939e-5

	y_zecd_12 = 7.97590705793e-5
	...
	y_zeco_1 = (-7.52202049496e-5)

	y_zeco_2 = (-7.94406933181e-5)

	y_zeco_3 = (-2.05931699614e-5)

	y_zeco_4 = 0.000100439779498

	y_zeco_5 = 2.12832185698e-5

	y_zeco_6 = 1.70353153588e-5

	y_zeco_7 = 5.5012376381e-5

	y_zeco_8 = 3.68085672111e-5
	...
	y_zeco_12 = (-3.46619140531e-5)

	y_zeco_13 = 7.48142887307e-5
	...
	y_zeco_18 = 2.60636593368e-5

	y_zeco_19 = (-6.06591388527e-5)

	y_zeco_20 = (-5.86151697491e-6)

	y_zeco_21 = 4.60869299242e-5

	y_zeco_22 = (-3.67533909379e-5)
	...
	y_zeh_1 = (-7.82590644729e-5)

	y_zeh_2 = (-5.22177650099e-5)

	y_zeh_3 = (-5.11617748264e-5)

	y_zeh_4 = 1.06118801985e-5

	y_zeh_5 = 0.00015247021427

	y_zeh_6 = 0.000115461916411

	y_zeh_7 = 6.94775905299e-5

	y_zeh_8 = 6.915284272e-6
	...
	y_zeh_12 = 4.42229725272e-5

	y_zeh_13 = 0.000171026724111

	y_zeh_14 = (-0.000344325005483)

	y_zeh_15 = 5.54746256755e-5

	y_zeh_16 = 4.07823169105e-5

	y_zeh_17 = (-3.07861940478e-5)

	y_zeh_18 = (-4.58464253978e-6)

	y_zeh_19 = 7.13641520669e-6

	y_zeh_20 = 1.47073943648e-5

	y_zeh_21 = 3.83084742308e-5

	y_zeh_22 = 3.27196755109e-5

	y_zeh_23 = (-6.99285491718e-5)

	y_zeh_24 = 4.55009661188e-7

	y_zeh_25 = 5.50461376242e-5

	y_zeh_26 = 2.86419262708e-5
	...
	y_zlhp_2 = (-6.54709155556e-5)

	y_zlhp_3 = (-0.000172024683014)

	y_zlhp_4 = 3.13937564958e-5
	...
	y_zpicxfe_21 = 6.84395376806e-5

	y_zpicxfe_22 = (-6.84395376806e-5)
