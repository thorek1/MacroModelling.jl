...
import Mooncake
import Pigeons
import Turing: NUTS, sample, logpdf, PG, IS, Beta, Normal, InverseGamma
...
samps = sample(Caldara_et_al_2012_loglikelihood, NUTS(250, 0.65, adtype = AutoMooncake(; config=nothing)), n_samples, progress = true, initial_params = init_params)
