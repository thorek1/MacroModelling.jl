...
```@repl tutorial_2
get_conditional_forecast(SW03, conditions, shocks = shocks, variables = [:Y,:pi,:C,:W])
```
...
```@repl tutorial_2
plot_conditional_forecast(SW03, conditions, shocks = shocks, variables = [:Y,:pi,:C,:W])
```

<!-- ![SW03 conditional forecast](../assets/conditional_fcst__SW03__conditional_forecast__1.png) -->
