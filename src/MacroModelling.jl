...
function write_functions_mapping!(𝓂::ℳ, max_perturbation_order::Int; 
    ...
    # Map steady state values from 𝔓 to ss_sym
    # Also need to map the corresponding 𝔙 entries for variables at steady state
    for i in 1:n_ss
    ...
    lennz_dyn_eqs = count(!iszero, dyn_eqs_substituted)
