...
function get_shock_decomposition(𝓂::ℳ,
    ...
    reference_steady_state, solution_error = 𝓂.solution.outdated_NSSS ? 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, verbose, 𝓂.solver_parameters) : (copy(𝓂.solution.non_stochastic_steady_state), eps())
...
function get_irf(𝓂::ℳ,
    ...
    reference_steady_state, solution_error = 𝓂.SS_solve_func(parameters, 𝓂, verbose, 𝓂.solver_parameters)
...
function get_steady_state(𝓂::ℳ; 
    ...
    SS, solution_error = 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, verbose, 𝓂.solver_parameters, 𝓂.solver_parameters)
...
function get_conditional_variance_decomposition(𝓂::ℳ; 
    ...
    SS_and_pars, _ = 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, verbose, 𝓂.solver_parameters)
...
function get_variance_decomposition(𝓂::ℳ; 
    ...
    SS_and_pars, solution_error = 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, verbose, 𝓂.solver_parameters)
...
function get_moments(𝓂::ℳ; 
    ...
    NSSS, solution_error = 𝓂.solution.outdated_NSSS ? 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, verbose, 𝓂.solver_parameters) : (copy(𝓂.solution.non_stochastic_steady_state), eps())
