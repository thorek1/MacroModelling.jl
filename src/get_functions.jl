...
function get_conditional_forecast(𝓂::ℳ,
    ...
    reference_steady_state, solution_error, iter = 𝓂.solution.outdated_NSSS ? 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, false, verbose, Dict(), [0.99778]) : (𝓂.solution.non_stochastic_steady_state, eps())
...
function get_irf(𝓂::ℳ,
    ...
    reference_steady_state, solution_error, iter = 𝓂.SS_solve_func(parameters, 𝓂, false, verbose, Dict(), [0.99778])
...
function get_steady_state(𝓂::ℳ; 
    ...
    SS, solution_error, iter = 𝓂.solution.outdated_NSSS ? 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, false, verbose, Dict(), [0.99778]) : (𝓂.solution.non_stochastic_steady_state, eps())
...
function get_conditional_variance_decomposition(𝓂::ℳ; 
    ...
    SS_and_pars, _, iter = 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, false, verbose, Dict(), [0.99778])
...
function get_variance_decomposition(𝓂::ℳ; 
    ...
    SS_and_pars, solution_error, iter = 𝓂.SS_solve_func(𝓂.parameter_values, 𝓂, false, verbose, Dict(), [0.99778])
