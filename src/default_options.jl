...
const DEFAULT_SYLVESTER_SELECTOR = 𝓂 -> sum(1:𝓂.constants.timings.nPast_not_future_and_mixed + 1 + 𝓂.constants.timings.nExo) > DEFAULT_SYLVESTER_THRESHOLD ? DEFAULT_LARGE_SYLVESTER_ALGORITHM : DEFAULT_SYLVESTER_ALGORITHM
