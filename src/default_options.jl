...
const DEFAULT_ARGS_AND_KWARGS_NAMES = Dict(
    ...
    :nsss => "NSSS tolerances",
    :first_order => "First-order tolerances",
    :second_order => "Second-order tolerances",
    :third_order => "Third-order tolerances",
    :qme => "QME tolerances",
    :sylvester => "Sylvester tolerances",
    :lyapunov => "Lyapunov tolerances",
    :ad => "AD tolerances",
    :tol => "Tolerance",
    :initial_guess_acceptance_tol => "Initial guess acceptance tol",
    :acceptance_tol => "Acceptance tol",
    :xtol => "X tol",
    :ftol => "F tol",
    :rel_xtol => "Relative X tol",
    :droptol => "Droptol",
