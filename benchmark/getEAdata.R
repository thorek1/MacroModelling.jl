...
awm <- import("~/Github/MacroModelling.jl/benchmark/awm19up15.csv")
...
TED <- "~/Github/MacroModelling.jl/benchmark/TED---Output-Labor-and-Labor-Productivity-1950-2015.xlsx"
